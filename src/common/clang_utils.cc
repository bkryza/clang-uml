...
*/
usr to_usr(const clang::Decl &decl)
{
    ...
    return usr{std::string{buf.data(), buf.size()}};
}

usr to_usr(const clang::QualType &type, const clang::ASTContext &ctx)
{
