...
;hljs.registerLanguage("markdown",e)})();/*! `makefile` grammar compiled for Highlight.js 11.7.0 */
...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `cpp` grammar compiled for Highlight.js 11.7.0 */
