...
<graphml xmlns="http://graphml.graphdrawing.org/xmlns" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://graphml.graphdrawing.org/xmlns http://graphml.graphdrawing.org/xmlns/1.0/graphml.xsd">
 ...
 <graph id="g0" edgedefault="directed" parse.nodeids="canonical" parse.edgeids="canonical" parse.order="nodesfirst">
  ...
  <node id="n0">
   ...
   <graph id="g1" edgedefault="directed" parse.nodeids="canonical" parse.edgeids="canonical" parse.order="nodesfirst">
    <node id="n1">
     ...
     <graph id="g2" edgedefault="directed" parse.nodeids="canonical" parse.edgeids="canonical" parse.order="nodesfirst">
      <node id="n2">
       ...
       <data key="nd4">https://github.com/bkryza/clang-uml/blob/1fa698c8f418c67d7d8c4f8e23c3e56636a93f97/tests/t00071/src/lib1.cppm#L4</data>
       <data key="nd5">B</data>
      </node>
      <node id="n3">
       <data key="nd1">class</data>
       ...
       <data key="nd4">https://github.com/bkryza/clang-uml/blob/1fa698c8f418c67d7d8c4f8e23c3e56636a93f97/tests/t00071/src/lib1.cppm#L6</data>
       <data key="nd5">BB</data>
      </node>
      <node id="n4">
       <data key="nd1">enum</data>
       <data key="nd2"><![CDATA[BBB]]></data>
       <data key="nd4">https://github.com/bkryza/clang-uml/blob/1fa698c8f418c67d7d8c4f8e23c3e56636a93f97/tests/t00071/src/lib1.cppm#L11</data>
      ...
      <node id="n5">
       ...
       <graph id="g3" edgedefault="directed" parse.nodeids="canonical" parse.edgeids="canonical" parse.order="nodesfirst">
        <node id="n6">
         ...
         <data key="nd6">false</data>
         <data key="nd4">https://github.com/bkryza/clang-uml/blob/1fa698c8f418c67d7d8c4f8e23c3e56636a93f97/tests/t00071/src/lib1mod1.cppm#L4</data>
         <data key="nd5">D</data>
        </node>
       </graph>
      </node>
      <node id="n7">
       ...
       <graph id="g4" edgedefault="directed" parse.nodeids="canonical" parse.edgeids="canonical" parse.order="nodesfirst">
        <node id="n8">
         ...
         <data key="nd6">false</data>
         <data key="nd4">https://github.com/bkryza/clang-uml/blob/1fa698c8f418c67d7d8c4f8e23c3e56636a93f97/tests/t00071/src/lib1mod2.cppm#L4</data>
         <data key="nd5">E</data>
        </node>
       </graph>
      </node>
    ...
    <node id="n9">
     ...
     <graph id="g5" edgedefault="directed" parse.nodeids="canonical" parse.edgeids="canonical" parse.order="nodesfirst">
      <node id="n10">
       ...
       <data key="nd6">false</data>
       <data key="nd4">https://github.com/bkryza/clang-uml/blob/1fa698c8f418c67d7d8c4f8e23c3e56636a93f97/tests/t00071/src/lib2.cppm#L4</data>
       <data key="nd5">C</data>
      </node>
      <node id="n11">
       <data key="nd1">class</data>
       ...
       <data key="nd6">true</data>
       <data key="nd4">https://github.com/bkryza/clang-uml/blob/1fa698c8f418c67d7d8c4f8e23c3e56636a93f97/tests/t00071/src/lib2.cppm#L6</data>
       <data key="nd5">CC</data>
      </node>
      <node id="n12">
       <data key="nd1">enum</data>
       <data key="nd2"><![CDATA[CCC]]></data>
       <data key="nd4">https://github.com/bkryza/clang-uml/blob/1fa698c8f418c67d7d8c4f8e23c3e56636a93f97/tests/t00071/src/lib2.cppm#L11</data>
    ...
    <node id="n13">
     ...
     <data key="nd6">false</data>
     <data key="nd4">https://github.com/bkryza/clang-uml/blob/1fa698c8f418c67d7d8c4f8e23c3e56636a93f97/tests/t00071/src/t00071_mod.cppm#L6</data>
     <data key="nd5">A</data>
    </node>
   </graph>
  </node>
  <node id="n14">
   ...
   <data key="nd6">false</data>
   <data key="nd4">https://github.com/bkryza/clang-uml/blob/1fa698c8f418c67d7d8c4f8e23c3e56636a93f97/tests/t00071/t00071.cc#L9</data>
   <data key="nd5">R</data>
  </node>
