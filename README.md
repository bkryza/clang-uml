...
[![Version](https://img.shields.io/badge/version-0.6.3-blue)](https://github.com/bkryza/clang-uml/releases)
[![Version](https://img.shields.io/badge/LLVM-12--22-orange)](https://github.com/bkryza/clang-uml/releases)
...
* **Class diagram generation**
    ...
    * Optional package generation from namespaces (not supported in MermaidJS) - [_example_](docs/test_cases/t00036.md)
    * Optional package generation from subdirectories (not supported in MermaidJS) - [_example_](docs/test_cases/t00065.md)
    * Optional package generation from C++20 modules (not supported in MermaidJS) - [_example_](docs/test_cases/t00071.md)
